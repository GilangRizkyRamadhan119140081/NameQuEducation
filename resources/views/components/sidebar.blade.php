        ...
        <div class="sidebar-wrapper sidebar-theme">
            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    <li class="menu {{ Request::routeIs('namequotient.index') ? 'active' : '' }}">
                        <a href="{{ route('namequotient.index') }}" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                    ...
                    <li class="menu {{ Request::routeIs('consultactivty') ? 'active' : '' }}">
                    ...
                    <li class="menu {{ Request::routeIs('chracterreader') ? 'active' : '' }}">
